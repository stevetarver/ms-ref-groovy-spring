 ...
 * errors in Kibana.
 *
 * TODO: Consider extending ResponseEntityExceptionHandler and overriding its handleExceptionInternal
 *       for a cleaner and more comprehensize solution
 *       see https://www.toptal.com/java/spring-boot-rest-api-error-handling
 * TODO: add class to exception handler annotation: e.g @ExceptionHandler(HttpMediaTypeNotSupportedException.class)
 */
@Slf4j
@ControllerAdvice
class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler
    ResponseEntity<JsonApiErrorResponse> handleResourceNotFoundException(com.makara.ms_ref_groovy_spring.exception.ResourceNotFoundInCollectionException e) {
    ...
    ResponseEntity<JsonApiErrorResponse> handleInvalidSignature(SignatureException signatureException) {
        log.error('Invalid signature for request',
    ...
    ResponseEntity<JsonApiErrorResponse> handleNoHandlerFoundException(
        ...
        log.error('No handler found exception - no rest api matches the given URI, method, and parameters',
    ...
    ResponseEntity<JsonApiErrorResponse> handleHttpMediaTypeNotSupportedException(
        ...
        log.error('Http media type not supported exception',
                kv(EXCEPTION_MSG, e.getMessage()),
    ...
    ResponseEntity<JsonApiErrorResponse> handleUnhandledThrowable(
            Throwable throwable) {
        log.error('Unhandled Throwable exception',
